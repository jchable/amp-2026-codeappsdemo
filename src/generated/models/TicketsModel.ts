...
export interface StatutValue {
  "@odata.type": string;
  Value: string;
  Id: number;
}

export interface PrioriteValue {
  "@odata.type": string;
  Value: string;
  Id: number;
}
...
export interface TicketsRead extends TicketsBase {
  Statut?: StatutValue;
...
export interface TicketsWrite extends TicketsBase {
  Statut?: string;
  Priorite?: string;
  Author?: AuthorValue;
  Editor?: EditorValue;
