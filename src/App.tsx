...
import { compter, filtrerParStatut, type Statut } from "./domain/ticket";

// Bascule mémoire <-> SharePoint. En démo, on démarre en mémoire puis on branche SharePoint.
...
export default function App() {
  ...
  return (
    <div className="app">
      <header>
        <h1>aMP Tickets</h1>
        <p className="sous">Nouveau {stats.Nouveau} · En cours {stats["En cours"]} · Résolu {stats.Résolu}</p>
      </header>
      ...
      <div className="colonnes">
        ...
        <aside><TicketForm onCreer={creer} /></aside>
      </div>
    </div>
  );
}
...
function demo() {
  ...
  return [
    { id: "d1", titre: "VPN inaccessible", description: "", statut: "En cours" as const, priorite: "Haute" as const, demandeur: "Julien", creeLe: now },
    { id: "d2", titre: "Badge d'accès HS", description: "", statut: "Nouveau" as const, priorite: "Moyenne" as const, demandeur: "Sarah", creeLe: now },
  ];
}
